...
urlpatterns = [
    ...
    path('editar_servico/', login_required(views.editar_servico, login_url='/login/'), name='editar_servico'),
    path('seleciona_servico/', login_required(views.seleciona_servico, login_url='/login/'), name='seleciona_servico'),
